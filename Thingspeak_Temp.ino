...
const char* ssid     = "larson"; // Your SSID (Name of your WiFi)
const char* password = "k1!@2345"; //Your Wifi password

const char* host = "api.thingspeak.com";
String api_key = "3ZH2VERW0X94W659"; // Your API Key provied by thingspeak
int value;
